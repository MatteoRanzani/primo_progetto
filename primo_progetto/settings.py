...
SECRET_KEY = 'django-insecure-+2x^d$epfqkb24x#vg6f+*0-a98wgry@((mm#+c9+ix-&@ymmr'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'prima_app/templates'),os.path.join(BASE_DIR,'templates'),os.path.join(BASE_DIR,'seconda_app/templates'),os.path.join(BASE_DIR,'prova_pratica_1/templates'),os.path.join(BASE_DIR,'voti/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
